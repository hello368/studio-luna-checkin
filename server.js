...
app.post('/api/checkin', async (req, res) => {
    try {
        ...
        console.log(`✅ [${new Date().toLocaleTimeString()}] Check-in: ${visit.name}`);
...
if (require.main === module) {
    app.listen(PORT, async () => {
        ...
        console.log(`---------------------------------`);
        console.warn('⚠️ IMPORTANT: Data is stored in a local JSON file (db/visits.json). This is NOT suitable for production or Vercel deployments as data will be lost on redeployments/serverless function invocations. Consider a proper database for production use.');
